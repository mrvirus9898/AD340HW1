...
class ZombieMovies : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.setTitle("Zombie Movies")

        /*Not my best work*/

        val zArray = arrayOfNulls<zMovie>(21)
        zArray[20] = zMovie(21, "Night of the Comet", 1984, "Thom Eberhardt",
                "http://collider.com/wp-content/uploads/2016/10/night-of-comet.jpg",
        ...
        zArray[19] = zMovie(20, "Dead Snow", 209, "Tommy Wirkola",
                "http://collider.com/wp-content/uploads/2016/07/dead-snow.jpg",
        ...
        zArray[18] = zMovie(19, "Cemetery Man", 2004, "Michele Soavi",
                "http://cdn.collider.com/wp-content/uploads/2017/10/cemetary-man.jpg",
        ...
        zArray[17] = zMovie(18, "28 Weeks Later", 2007, "Juan Carlos Fresnadillo",
                "http://collider.com/wp-content/uploads/2015/08/28-weeks-later.jpg",
        ...
        zArray[16] = zMovie(17, "Night of the Creeps", 1986, "Fred Dekker",
                "http://cdn.collider.com/wp-content/uploads/2017/10/night-of-the-creeps.jpg",
        ...
        zArray[15] = zMovie(16,"ParaNorman", 2012, "Chris Butler, Sam Fell",
                "http://collider.com/wp-content/uploads/paranorman-movie-image.jpg",
        ...
        zArray[14] = zMovie(15,"Zombieland",2009, "Ruben Fleischer",
                "http://collider.com/wp-content/uploads/Zombieland-movie-image-Woody-Harrelson-Jesse-Eisenberg-1.jpg",
        ...
        zArray[13] = zMovie (14,"Planet Terror", 2007, "Robert Rodriguez",
                "http://collider.com/wp-content/uploads/rose_mcgowan_and_marley_shelton_star_in_robert_rodriquez_s_planet_terror_grindhouse_s.jpg",
        ...
        zArray[12] = zMovie(13,"Train to Busan", 2016, "Sang-ho Yen",
                "http://collider.com/wp-content/uploads/2016/12/train-to-busan-movie-image.jpg",
        ...
        zArray[11] = zMovie(12,"The Beyond", 1981, "Lucio Fulci",
                "http://cdn.collider.com/wp-content/uploads/2017/10/the-beyond.jpg",
        ...
        zArray[10] = zMovie(11,"Day of the Dead", 1985, "George Romero",
                "http://cdn.collider.com/wp-content/uploads/2017/10/day-of-the-dead.jpg",
        ...
        zArray[9] = zMovie(10,"The Serpent & the Rainbow", 1988, "Wes Craven",
                "http://cdn.collider.com/wp-content/uploads/2017/10/the-serpent-and-the-rainbow.jpg",
        ...
        zArray[8] = zMovie(9,"Re-Animator", 1985, "Stuart Gordon",
                "http://collider.com/wp-content/uploads/2016/09/re-animator.jpg",
        ...
        zArray[7] = zMovie (8,"Zombi 2",1971, "Lucio Fulci",
                "http://collider.com/wp-content/uploads/2016/10/zombi-2.jpg",
        ...
        zArray[6] = zMovie(7,"Dawn of the Dead", 2004, "Zack Snyder",
                "http://collider.com/wp-content/uploads/2016/10/dawn-of-the-dead.jpg",
        ...
        zArray[5] = zMovie(6,"Return of the Living Dead", 1985, "Dan O'Bannon",
                "http://collider.com/wp-content/uploads/return_of_the_living_dead_movie_image_01.jpg",
        ...
        zArray[4] = zMovie(5, "Dead Alive", 1992, "Peter Jackson",
                "http://collider.com/wp-content/uploads/2016/04/dead-alive.jpg",
        ...
        zArray[3] = zMovie(4,"28 Days Later", 2002, "Danny Boyle",
                "http://collider.com/wp-content/uploads/2016/10/28-days-later.jpg",
        ...
        zArray[2] = zMovie(3,"Night of the Living Dead", 1968, "George Romero",
                "http://collider.com/wp-content/uploads/2015/10/night-of-the-living-dead.jpg",
        ...
        zArray[1] = zMovie(2,"Shawn of the Dead", 2004, "Edgar Wright",
                "http://collider.com/wp-content/uploads/2014/10/shaun-of-the-dead-image.jpg",
        ...
        zArray[0] = zMovie(1,"Dawn of the Dead", 1978, "George Romero",
                "http://collider.com/wp-content/uploads/2015/08/dawn-of-the-dead-romero.jpg",
        ...
        val zGson = Gson()
        val outputString = zGson.toJson(zArray[0])



        viewManager = LinearLayoutManager(this)
        viewAdapter = MyAdapter(zArray, this)
    ...
    class zMovie(rank : Int = 0, title: String = "", year:Int = 0, director:String = "place holder", image:String = "place holder", description:String ="place holder" ) : Parcelable {
        val rank = rank
        val year = year
        val title = title
    ...
    class MyAdapter(private val myDataset: Array<zMovie?>, private val mContext : ZombieMovies) :
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.textView.text = myDataset[position]?.rank.toString() + ". " + myDataset[position]?.title + "(" + myDataset[position]?.year.toString() + ")"
            holder.textView.setOnClickListener {
                val intent = Intent(mContext, displayZombie::class.java).apply {
                    putExtra("Rank", myDataset[position]?.rank)
                    println(myDataset[position]?.rank)
                    putExtra("Title", myDataset[position]?.title)
                    putExtra("Year", myDataset[position]?.year)
